...
//zhenglihong@wind-mobi.com 20171122 begin
		...
		#else
		if ((0 == strcmp(s_ctrl->sensordata->sensor_name,"s5k3l8_lcetron"))||(0 == strcmp(s_ctrl->sensordata->sensor_name,"ov13855_lcetron")) || (0 == strcmp(s_ctrl->sensordata->sensor_name,"s5k4h7"))||(0 == strcmp(s_ctrl->sensordata->sensor_name,"ar1337"))) {
                               sensorid = 0;     
		 } else if ((0 == strcmp(s_ctrl->sensordata->sensor_name,"hi846_aux"))  || (0 == strcmp(s_ctrl->sensordata->sensor_name,"ov8856_aux"))){
                                sensorid = 1;     
		  } else if ((0 == strcmp(s_ctrl->sensordata->sensor_name,"hi846"))  || (0 == strcmp(s_ctrl->sensordata->sensor_name,"ov8856"))|| (0 == strcmp(s_ctrl->sensordata->sensor_name,"ov13858")) || (0 == strcmp(s_ctrl->sensordata->sensor_name,"hi1332_lcetron")) || (0 == strcmp(s_ctrl->sensordata->sensor_name,"hi556")) || (0 == strcmp(s_ctrl->sensordata->sensor_name,"s5k5e8")) || (0 == strcmp(s_ctrl->sensordata->sensor_name,"gc5005")) || (0 == strcmp(s_ctrl->sensordata->sensor_name,"gc8034"))) {
                                sensorid = 2 ;     
		  }  else {
                               pr_err("camera fail id\n");
		  }
